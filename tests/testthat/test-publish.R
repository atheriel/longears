...
testthat::test_that("basic publish works as expected", {
  ...
  testthat::expect_error(amqp_publish(conn, body = c("Hello", "world"), exchange = "test.exchange", routing_key = "#"))
  testthat::expect_error(amqp_publish(conn, body = list('Hello'), exchange = "test.exchange", routing_key = "#"))
  ...
  amqp_publish(conn, body = charToRaw("hello"), exchange = "test.exchange", routing_key = '#')
